    ...
    <div>
      ...
      <main style={{ maxWidth: "1000px", margin: "0 auto", padding: "2rem" }}>
        ...
        <section style={sectionStyle}>
          <img src="/scottsdale-oasis.jpg" alt="The Scottsdale Oasis living room" style={imgStyle} />
        ...
        <section style={sectionStyle}>
          <img src="/sunrise-condo.jpg" alt="The Sunrise Condo photo" style={imgStyle} />
...
/* ---- Shared styles ---- */
const sectionStyle = { margin: "2rem 0", padding: "1.25rem", border: "1px solid #e5e7eb", borderRadius: "1rem" };
const imgStyle = { width: "100%", borderRadius: "0.75rem", marginBottom: "1rem" };
const titleStyle = { fontSize: "1.5rem", marginBottom: ".25rem" };
const subtitleStyle = { margin: ".25rem 0 1rem", color: "#374151" };
const chipWrapper = { display: "flex", flexWrap: "wrap", gap: ".5rem", margin: "0 0 1rem" };
const chipStyle = { padding: ".25rem .6rem", border: "1px solid #d1d5db", borderRadius: "999px", fontSize: ".9rem" };
const noteStyle = { margin: "0 0 1rem", color: "#6b7280" };
const btnWrapper = { display: "flex", gap: ".75rem", flexWrap: "wrap" };
const btnStyle = { textDecoration: "none", padding: ".6rem 1rem", border: "1px solid #111827", borderRadius: ".75rem", fontWeight: 600 };
